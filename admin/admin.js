...
const COVERAGE = {
  stats: [['201','Tests'],['196','Passed'],['5','Env-gated skips'],['24','Suites'],['75.7%','Lines, instrumented'],['2','Files not exercised']],
  files: [
    ...
    { f:'api/admin/media.js', l:96.3, b:59.2, fn:100, n:'' },
    { f:'api/admin/posts.js', l:97.2, b:80.4, fn:100, n:'admin-posts-api' },
    ...
    { f:'api/_blog-data.js', l:100, b:93.3, fn:94.1, n:'render-handlers' },
    { f:'api/_blog-index-template.js', l:100, b:100, fn:100, n:'via blog-index' },
    { f:'api/_body.js', l:100, b:100, fn:100, n:'read-body' },
    { f:'api/_media.js', l:100, b:85, fn:100, n:'media-library listing glue' },
    ...
    { f:'admin/admin.js', l:26.8, b:90.8, fn:29.3, n:'admin-editor · picker/alt-bar/helpers; view flows untested' },
    { g:'Scripts' },
